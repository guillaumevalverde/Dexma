...
public class RecursiveAlgo  extends BaseTest {
    ...
    public void putOneCoinGetItBackTest() {
        ...
        Map<Euro, Integer> change = ChangeRecursiveAlgo.getChangeRecursive(coins, 0.5f);
    ...
    public void putTwoCoinGetItBackTest() {
        ...
        Map<Euro, Integer> change = ChangeRecursiveAlgo.getChangeRecursive(coins, 3f);
    ...
    public void testSimple4Test() {
        ...
        Map<Euro, Integer> change = ChangeRecursiveAlgo.getChangeRecursive(coins, 2.5f);
    ...
    public void testSimple5Test() {
        ...
        Map<Euro, Integer> change = ChangeRecursiveAlgo.getChangeRecursive(coins, 1.5f);
    ...
    public void recursiveAlgoTest() {
        ...
        Map<Euro, Integer> change = ChangeRecursiveAlgo.getChangeRecursive(coins, 0.8f);
    ...
    public void recursiveAlgo2Test() {
        ...
        Map<Euro, Integer> change = ChangeRecursiveAlgo.getChangeRecursive(coins, 2.9f);
    ...
    public void recursiveAlgo3Test() {
        List<CoinInMachine> coins = new ArrayList<>();
        coins.add(new CoinInMachine(new Euro(0.6f),2));
        coins.add(new CoinInMachine(new Euro(1f),1));
        coins.add(new CoinInMachine(new Euro(2f),1));

        Map<Euro, Integer> change = ChangeRecursiveAlgo.getChangeRecursive(coins, 3.2f);

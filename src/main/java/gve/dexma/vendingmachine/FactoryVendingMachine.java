...
import gve.dexma.vendingmachine.implementation.VendingMachineImpl;
...
public class FactoryVendingMachine {
    ...
    public static final Map<Euro, Integer> getInitializedCoin() {
    ...
    public static final Map<Product, Integer> getInitializedProduct() {
    ...
    public VendingMachine getMachineInitialized() {
        return new VendingMachineImpl(getInitializedCoin(), getInitializedProduct());
    }
}
